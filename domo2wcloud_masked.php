...
$wcloud_id = "weathercloud_id";
$wcloud_key = "weathercloud_key";
...
// changes for weathercloud format
...
$part_data="/temp/$temp_ext/temp_in/$temp_int/hum/$hum/bar/$bar/rain/$rain/wspd/$speed/wdir/$dir";
